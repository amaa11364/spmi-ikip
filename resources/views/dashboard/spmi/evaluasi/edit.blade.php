                    ...
                    <form action="{{ route('spmi.evaluasi.update', $evaluasi->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_komponen" 
                                   value="{{ $evaluasi->nama_komponen }}" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="tahun" 
                                       value="{{ $evaluasi->tahun }}" min="2000" max="{{ date('Y') + 5 }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="penanggung_jawab" 
                                       value="{{ $evaluasi->penanggung_jawab }}">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('spmi.evaluasi.show', $evaluasi->id) }}" class="btn btn-secondary">
