...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <select class="form-select" name="tipe_evaluasi" required>
            <option value="ami" {{ $evaluasi->tipe_evaluasi == 'ami' ? 'selected' : '' }}>Audit Mutu Internal (AMI)</option>
            <option value="edom" {{ $evaluasi->tipe_evaluasi == 'edom' ? 'selected' : '' }}>Evaluasi Dosen oleh Mahasiswa (EDOM)</option>
