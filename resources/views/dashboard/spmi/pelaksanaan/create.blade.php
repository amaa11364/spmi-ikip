...
@section('title', 'Tambah Pelaksanaan SPMI')
...
<div class="container-fluid px-3 px-md-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Pelaksanaan</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-plus-circle me-2"></i> Tambah Pelaksanaan SPMI
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('spmi.pelaksanaan.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('tahun') is-invalid @enderror" 
                                       name="tahun" value="{{ old('tahun', date('Y')) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status_dokumen') is-invalid @enderror" name="status_dokumen">
                                    <option value="belum_valid" {{ old('status_dokumen', 'belum_valid') == 'belum_valid' ? 'selected' : '' }}>Belum Valid</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" 
                                      rows="4" placeholder="Deskripsi singkat tentang kegiatan pelaksanaan">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save me-2"></i> Simpan Pelaksanaan
                            </button>
                        </div>
                    </form>
                </div>
